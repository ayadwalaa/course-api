...
public class CourseController {
	...
	public Course getCourse(@PathVariable Long id) {// annotation is to map the variable in the annotation with the argument here
	...
	public void deleteCourse(@RequestBody Course topic, @PathVariable Long id) {
